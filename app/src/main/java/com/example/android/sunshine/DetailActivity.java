   ...
   mDetailBinding= DataBindingUtil.setContentView(this,R.layout.activity_detail);
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
       ...
       mDetailBinding.weatherInfo.weatherDescription.setContentDescription(descriptionA11y);
        ...
        mDetailBinding.weatherInfo.weatherIcon.setContentDescription(descriptionA11y);
        ...
        mDetailBinding.weatherInfo.highTemperature.setContentDescription(highA11y);
...
//      COMPLETED (11) Use mDetailBinding to display the low temperature and set the content description
        ...
        mDetailBinding.weatherInfo.lowTemperature.setContentDescription(lowA11y);
...
//      COMPLETED (12) Use mDetailBinding to display the humidity and set the content description
        /* Set the text and content description (for accessibility purposes) */
        mDetailBinding.weatherDetail.humidity.setText(humidityString);
        mDetailBinding.weatherDetail.humidity.setContentDescription(humidityA11y);
...
//     Use mDetailBinding to display the wind and set the content description
        /* Set the text and content description (for accessibility purposes) */
        mDetailBinding.weatherDetail.windMeasurement.setText(windString);
        mDetailBinding.weatherDetail.windMeasurement.setContentDescription(windA11y);
...
//      COMPLETED (14) Use mDetailBinding to display the pressure and set the content description
        /* Set the text and content description (for accessibility purposes) */
        mDetailBinding.weatherDetail.pressure.setText(pressureString);
        mDetailBinding.weatherDetail.pressure.setContentDescription(pressureA11y);
